...
public class CacheController : Object {
    ...
    public void change_state (ContentType content_type,
                              string content_id,
                              CacheingState state) {
        /**
    ...
    public void start_loading (ContentType content_type,
                               string content_id) {
        /**
    ...
    public void stop_loading (ContentType content_type,
                              string content_id,
                              CacheingState? state) {
        /**
    ...
    public CacheingState get_content_cache_state (ContentType content_type,
                                                  string content_id) {
        /**
