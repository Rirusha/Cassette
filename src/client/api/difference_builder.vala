...
namespace CassetteClient.YaMAPI {
    ...
    public class DifferenceBuilder : Object {
        ...
        private ArrayList<DeleteOperation> delete_operations = new ArrayList<DeleteOperation> ();
        private ArrayList<InsertOperation> insert_operations = new ArrayList<InsertOperation> ();
