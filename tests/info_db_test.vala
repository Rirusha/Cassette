...
public int main (string[] args) {
    ...
    Logger.set_log_file (File.new_for_path ("./test.log"));
    ...
    Test.add_func ("/db_info/additional/set", () => {
        var db = new InfoDB ("test.db");

        db.set_additional_data ("test_name", "42");
    });

    Test.add_func ("/db_info/additional/get", () => {
        var db = new InfoDB ("test.db");
    ...
    Test.add_func ("/db_info/track_ref/set", () => {
        var db = new InfoDB ("test.db");
    ...
    Test.add_func ("/db_info/track_ref/get", () => {
        var db = new InfoDB ("test.db");
    ...
    Test.add_func ("/db_info/track_ref/remove", () => {
        var db = new InfoDB ("test.db");
